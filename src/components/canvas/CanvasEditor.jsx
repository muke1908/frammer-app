...
export default function CanvasEditor({ imageState, cropState, frameConfig, children }) {
  ...
  return (
    <div className="canvas-editor">
      <CanvasRenderer image={imageState.original} crop={crop} frameConfig={frameConfig} />
      {children}
    </div>
  );
}
